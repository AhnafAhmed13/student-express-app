...
export namespace Prisma {
  ...
  */
  ...
  export interface StudentDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
     ...
     * 
     * // Only select the `sId`
     * const studentWithSIdOnly = await prisma.student.findMany({ select: { sId: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Students and only return the `sId`
     * const studentWithSIdOnly = await prisma.student.createManyAndReturn({ 
     *   select: { sId: true },
     *   data: [
     *     // ... provide data here
     *   ]
